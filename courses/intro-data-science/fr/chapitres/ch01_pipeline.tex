...
% --- hook ---
En 1854, le m\'edecin londonien John Snow trace sur une carte de Soho l'emplacement de chaque d\'ec\`es par chol\'era. Les points s'agglutinent autour d'une pompe \`a eau de Broad Street. Snow demande aux autorit\'es de retirer la manivelle de la pompe~; l'\'epid\'emie s'\'eteint en quelques jours. Personne, \`a l'\'epoque, ne savait que la maladie se transmet par l'eau~: la th\'eorie microbienne n'existe pas encore. Snow ne d\'emontre rien au sens m\'edical du terme~; il fait quelque chose de plus mod\'erne. Il pose une question (\og{}qui meurt~?\fg{}), collecte des donn\'ees (les registres de d\'ec\`es), les g\'eolocalise (la carte), rep\`ere un motif (la concentration spatiale), formule une hypoth\`ese causale (l'eau contamin\'ee) et agit sur le monde (la manivelle). C'est, \`a cent soixante-dix ans pr\`es, le pipeline standard d'un projet de science des donn\'ees. Ce chapitre d\'eroule chacun de ces maillons --- question, ingestion, exploration, mod\'elisation, communication --- et explique pourquoi sauter l'un d'eux suffit \`a transformer un projet ambitieux en tableau de bord que personne ne regarde.
