...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Quantitative Finance};
...
\input{chapters/ch01_markets}
\input{chapters/ch02_black_scholes}
\input{chapters/ch03_pricing}
\input{chapters/ch04_hedging}
\input{chapters/ch05_stochastic_calculus}
\input{chapters/ch06_volatility}
\input{chapters/ch07_interest_rates}
\input{chapters/ch08_portfolio}
\input{chapters/ch09_risk}
\input{chapters/ch10_exotic}
\input{chapters/ch11_ml_finance}
