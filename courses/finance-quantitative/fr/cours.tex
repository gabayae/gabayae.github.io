...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Finance Quantitative};
  ...
  \node[anchor=north, text=blue!50!black, font=\large]
    at ([yshift=-5.5cm]current page.center) {Master M2 --- 2025--2026};
...
\input{chapitres/ch01_marches}
\input{chapitres/ch02_black_scholes}
\input{chapitres/ch03_pricing}
\input{chapitres/ch04_couverture}
\input{chapitres/ch05_calcul_stochastique}
\input{chapitres/ch06_volatilite}
\input{chapitres/ch07_taux}
\input{chapitres/ch08_portefeuille}
\input{chapitres/ch09_risque}
\input{chapitres/ch10_exotiques}
\input{chapitres/ch11_ml_finance}

\backmatter
\begin{thebibliography}{99}
\bibitem{hull} Hull, J.C., \emph{Options, Futures, and Other Derivatives}, 11th ed., Pearson, 2022.
\bibitem{shreve} Shreve, S.E., \emph{Stochastic Calculus for Finance II}, Springer, 2004.
\bibitem{brigo} Brigo, D. and Mercurio, F., \emph{Interest Rate Models}, 2nd ed., Springer, 2006.
\bibitem{bjork} Bj\"ork, T., \emph{Arbitrage Theory in Continuous Time}, 4th ed., Oxford, 2020.
\bibitem{lamberton} Lamberton, D. and Lapeyre, B., \emph{Introduction au calcul stochastique appliqu\'e \`a la finance}, 3rd ed., Ellipses, 2012.
\end{thebibliography}
\printindex
\end{document}