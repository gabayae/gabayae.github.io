...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Natural Language Processing};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {``The limits of my language mean the limits of my world.''\\[4pt]--- Ludwig Wittgenstein};
...
\input{chapters/ch02_representations}
\input{chapters/ch03_embeddings}
\input{chapters/ch04_sequences}
\input{chapters/ch05_attention}
\input{chapters/ch06_pretrained}
\input{chapters/ch07_finetuning}
\input{chapters/ch08_generation}
\input{chapters/ch09_rag}
\input{chapters/ch10_evaluation}
\input{chapters/ch11_ethics}
