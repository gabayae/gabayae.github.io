...
Le traitement automatique des langues a connu trois révolutions en vingt ans : les méthodes statistiques de la fin des années 1990, les plongements distribués (Word2Vec, GloVe) du milieu des années 2010, et l'architecture Transformer (\textit{Attention Is All You Need}, 2017) qui a tout balayé. Les grands modèles de langage actuels --- GPT-4, Claude, Llama, Gemini --- sont les héritiers directs de cette dernière, à des échelles que personne n'imaginait il y a dix ans.
