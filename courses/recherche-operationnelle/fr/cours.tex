...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Recherche Op\'erationnelle};
...
\input{chapitres/ch02_programmation_lineaire}
\input{chapitres/ch03_simplexe}
\input{chapitres/ch04_dualite}
\input{chapitres/ch05_sensibilite}
\input{chapitres/ch06_transport}
\input{chapitres/ch07_graphes}
\input{chapitres/ch08_flots}
\input{chapitres/ch09_nombres_entiers}
\input{chapitres/ch10_non_lineaire}
\input{chapitres/ch11_simulation}

\backmatter
\begin{thebibliography}{99}
\bibitem{hillier} Hillier, F.S. and Lieberman, G.J., \emph{Introduction to Operations Research}, 11th ed., McGraw-Hill, 2021.
\bibitem{bertsimas} Bertsimas, D. and Tsitsiklis, J.N., \emph{Introduction to Linear Optimization}, Athena Scientific, 1997.
\bibitem{gondran} Gondran, M. and Minoux, M., \emph{Graphes et Algorithmes}, 4th ed., Lavoisier, 2009.
\end{thebibliography}
\printindex
\end{document}