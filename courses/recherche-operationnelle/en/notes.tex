...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Operations Research};
...
\input{chapters/ch02_linear_programming}
\input{chapters/ch03_simplex}
\input{chapters/ch04_duality}
\input{chapters/ch05_sensitivity}
\input{chapters/ch06_transportation}
\input{chapters/ch07_graphs}
\input{chapters/ch08_flows}
\input{chapters/ch09_integer}
\input{chapters/ch10_nonlinear}
\input{chapters/ch11_simulation}
