...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries]
    at ([yshift=-6cm]current page.north) {Measure and Integration};
  ...
  \node[anchor=center, text width=12cm, align=center, text=blue!60!black, font=\itshape]
    at ([yshift=-16cm]current page.north) {``One must know when to doubt, when to submit, and when to believe.''\\[4pt]--- Blaise Pascal};
...
\input{chapters/ch01_sigma_algebras}
\input{chapters/ch02_measures}
\input{chapters/ch03_caratheodory}
\input{chapters/ch04_lebesgue}
\input{chapters/ch05_measurable_functions}
\input{chapters/ch06_integral}
\input{chapters/ch07_convergence}
\input{chapters/ch08_lp_spaces}
\input{chapters/ch09_signed_measures}
\input{chapters/ch10_radon_nikodym}
\input{chapters/ch11_fubini}
\input{chapters/ch12_radon_riesz}
