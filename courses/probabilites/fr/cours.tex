...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Probabilit\'es};
...
La théorie des probabilités a longtemps vécu sans fondement rigoureux : Pascal, Fermat, Laplace, Poisson, Tchebychev ont produit des résultats profonds en s'appuyant sur des intuitions qu'aucun cadre formel ne validait. C'est Kolmogorov qui, en 1933, a unifié l'ensemble en une axiomatique fondée sur la théorie de la mesure : un espace probabilisé n'est rien d'autre qu'un espace mesuré de masse $1$, une variable aléatoire est une fonction mesurable, l'espérance est une intégrale.
...
\input{chapitres/ch01_espaces}
\input{chapitres/ch02_conditionnelle}
\input{chapitres/ch03_discretes}
\input{chapitres/ch04_continues}
\input{chapitres/ch05_esperance}
\input{chapitres/ch06_lois}
\input{chapitres/ch07_fonctions_va}
\input{chapitres/ch08_couples}
\input{chapitres/ch09_grands_nombres}
\input{chapitres/ch10_tcl}
\input{chapitres/ch11_caracteristiques}
\input{chapitres/ch12_markov}
