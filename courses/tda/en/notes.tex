...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Topological Data Analysis};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {``Topology is precisely the mathematical discipline that allows the passage from local to global.''\\[4pt]--- Ren\'e Thom};
...
\input{chapters/ch01_motivations}
\input{chapters/ch02_simplicial}
\input{chapters/ch03_persistent}
\input{chapters/ch04_diagrams}
\input{chapters/ch05_stability}
\input{chapters/ch06_complexes}
\input{chapters/ch07_mapper}
\input{chapters/ch08_distances}
\input{chapters/ch09_ml_tda}
\input{chapters/ch10_applications}
\input{chapters/ch11_deep_tda}
