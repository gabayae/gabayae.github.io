...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Reinforcement Learning};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {``Can a machine think? This question is about as relevant as: can a submarine swim?''\\[4pt]--- Edsger Dijkstra};
...
\input{chapters/ch01_mdp}
\input{chapters/ch02_dynamic_programming}
\input{chapters/ch03_monte_carlo}
\input{chapters/ch04_q_learning}
\input{chapters/ch05_dqn}
\input{chapters/ch06_policy_gradient}
\input{chapters/ch07_actor_critic}
\input{chapters/ch08_sota}
\input{chapters/ch09_multi_agent}
\input{chapters/ch10_constrained}
