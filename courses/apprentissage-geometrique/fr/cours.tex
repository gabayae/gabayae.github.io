...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Apprentissage G\'eom\'etrique};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {<<\,La g\'eom\'etrie est l'art de raisonner juste sur des figures fausses.\,>>\\[4pt]--- Henri Poincar\'e};
...
\input{chapitres/ch02_groupes}
\input{chapitres/ch03_gnn}
\input{chapitres/ch04_variantes}
\input{chapitres/ch05_spectral}
\input{chapitres/ch06_varietes}
\input{chapitres/ch07_equivariants}
\input{chapitres/ch08_point_clouds}
\input{chapitres/ch09_applications}
\input{chapitres/ch10_tda}
\input{chapitres/ch11_recherche}

\backmatter
\begin{thebibliography}{99}
\bibitem{bronstein} Bronstein, M.M. et al., \emph{Geometric Deep Learning: Grids, Groups, Graphs, Geodesics, and Gauges}, arXiv:2104.13478, 2021.
\bibitem{hamilton} Hamilton, W.L., \emph{Graph Representation Learning}, Morgan \& Claypool, 2020.
\bibitem{kipf} Kipf, T.N. and Welling, M., Semi-Supervised Classification with Graph Convolutional Networks, \emph{ICLR}, 2017.
\bibitem{velickovic} Veli\v{c}kovi\'c, P. et al., Graph Attention Networks, \emph{ICLR}, 2018.
\end{thebibliography}
\printindex
\end{document}