...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Geometric Learning};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {``Geometry is the art of reasoning well from badly drawn figures.''\\[4pt]--- Henri Poincar\'e};
...
\input{chapters/ch02_groups}
\input{chapters/ch03_gnn}
\input{chapters/ch04_variants}
\input{chapters/ch05_spectral}
\input{chapters/ch06_manifolds}
\input{chapters/ch07_equivariant}
\input{chapters/ch08_point_clouds}
\input{chapters/ch09_applications}
\input{chapters/ch10_tda}
\input{chapters/ch11_research}
