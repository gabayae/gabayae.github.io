...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries]
    at ([yshift=-6cm]current page.north) {G\'eom\'etrie Riemannienne};
  ...
  \node[anchor=center, text width=12cm, align=center, text=blue!60!black, font=\itshape]
    at ([yshift=-16cm]current page.north) {<<\,La g\'eom\'etrie n'est pas vraie, elle est avantageuse.\,>>\\[4pt]--- Henri Poincar\'e};
...
\input{chapitres/ch01_varietes}
\input{chapitres/ch02_connexions}
\input{chapitres/ch03_levi_civita}
\input{chapitres/ch04_geodesiques}
\input{chapitres/ch05_courbure}
\input{chapitres/ch06_courbures}
\input{chapitres/ch07_comparaison}
\input{chapitres/ch08_symetriques}
\input{chapitres/ch09_bonnet_myers}
\input{chapitres/ch10_sous_varietes}
\input{chapitres/ch11_ricci_flow}
