...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Processus Stochastiques};
...
\input{chapitres/ch02_definitions}
\input{chapitres/ch03_markov_discret}
\input{chapitres/ch04_markov_continu}
\input{chapitres/ch05_poisson}
\input{chapitres/ch06_martingales_discret}
\input{chapitres/ch07_martingales_continu}
\input{chapitres/ch08_brownien}
\input{chapitres/ch09_ito_integrale}
\input{chapitres/ch10_ito_eds}
\input{chapitres/ch11_applications}

\backmatter
\begin{thebibliography}{99}
\bibitem{revuzyor} Revuz, D. and Yor, M., \emph{Continuous Martingales and Brownian Motion}, 3rd ed., Springer, 1999.
\bibitem{karatzas} Karatzas, I. and Shreve, S.E., \emph{Brownian Motion and Stochastic Calculus}, 2nd ed., Springer, 1991.
\bibitem{durrett} Durrett, R., \emph{Probability: Theory and Examples}, 5th ed., Cambridge, 2019.
\bibitem{norris} Norris, J.R., \emph{Markov Chains}, Cambridge, 1997.
\bibitem{protter} Protter, P.E., \emph{Stochastic Integration and Differential Equations}, 2nd ed., Springer, 2005.
\end{thebibliography}
\printindex
\end{document}