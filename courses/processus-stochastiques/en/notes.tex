...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Stochastic Processes};
...
\input{chapters/ch01_review}
\input{chapters/ch02_definitions}
\input{chapters/ch03_discrete_markov}
\input{chapters/ch04_continuous_markov}
\input{chapters/ch05_poisson}
\input{chapters/ch06_discrete_martingales}
\input{chapters/ch07_continuous_martingales}
\input{chapters/ch08_brownian}
\input{chapters/ch09_ito_integral}
\input{chapters/ch10_ito_sde}
