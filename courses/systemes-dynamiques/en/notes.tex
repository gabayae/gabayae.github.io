...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Dynamical Systems};
...
\input{chapters/ch01_definitions}
\input{chapters/ch02_lyapunov}
\input{chapters/ch03_linear}
\input{chapters/ch04_nonlinear}
\input{chapters/ch05_limit_cycles}
\input{chapters/ch06_bifurcations}
\input{chapters/ch07_chaos}
\input{chapters/ch08_exponents}
\input{chapters/ch09_attractors}
\input{chapters/ch10_discrete}
\input{chapters/ch11_ergodic}
