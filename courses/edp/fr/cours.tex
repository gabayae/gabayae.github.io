...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {\'Equations aux D\'eriv\'ees Partielles};
...
\input{chapitres/ch02_transport}
\input{chapitres/ch03_fourier}
\input{chapitres/ch04_chaleur}
\input{chapitres/ch05_ondes}
\input{chapitres/ch06_laplace}
\input{chapitres/ch07_maximum}
\input{chapitres/ch08_transformee_fourier}
\input{chapitres/ch09_sobolev}
\input{chapitres/ch10_variationnel}

\backmatter
\begin{thebibliography}{99}
\bibitem{evans} Evans, L.C., \emph{Partial Differential Equations}, 2nd ed., AMS, 2010.
\bibitem{brezis} Brezis, H., \emph{Functional Analysis, Sobolev Spaces and PDE}, Springer, 2011.
\bibitem{john} John, F., \emph{Partial Differential Equations}, 4th ed., Springer, 1982.
\bibitem{rauch} Rauch, J., \emph{Partial Differential Equations}, Springer, 1991.
\bibitem{zuily} Zuily, C., \emph{Distributions et \'equations aux d\'eriv\'ees partielles}, Hermann, 2002.
\end{thebibliography}
\printindex
\end{document}