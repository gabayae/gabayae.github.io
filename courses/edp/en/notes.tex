...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Partial Differential Equations};
...
\input{chapters/ch02_transport}
\input{chapters/ch03_fourier}
\input{chapters/ch04_heat}
\input{chapters/ch05_wave}
\input{chapters/ch06_laplace}
\input{chapters/ch07_maximum}
\input{chapters/ch08_fourier_transform}
\input{chapters/ch09_sobolev}
\input{chapters/ch10_variational}
