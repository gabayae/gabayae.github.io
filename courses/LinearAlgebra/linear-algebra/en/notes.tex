...
\input{chapters/ch0-preliminaries}
\input{chapters/ch1-vector-spaces}
\input{chapters/ch2-linear-maps}
\input{chapters/ch3-linear-systems}
\input{chapters/ch4-determinants}
\input{chapters/ch5-eigenvalues}
\input{chapters/ch6-inner-products}
\input{chapters/ch7-spectral-theorem}
