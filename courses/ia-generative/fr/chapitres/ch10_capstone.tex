...
Ce chapitre pr\'esente cinq projets de fin de cours. Chaque projet int\`egre des notions de plusieurs chapitres et aboutit \`a une application compl\`ete d\'eployable. Choisissez-en un (ou plusieurs) selon vos int\'er\^ets.
