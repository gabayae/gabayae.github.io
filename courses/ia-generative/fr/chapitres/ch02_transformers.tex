...
% --- hook ---
Avant 2017, les modèles de séquence lisaient le texte mot par mot, de gauche à droite, et oubliaient le début quand ils arrivaient à la fin. Les RNN avaient deux problèmes durs : pas de parallélisme, et un contexte qui s'efface. Le Transformer a balayé les deux d'un coup avec un seul mécanisme --- l'attention. Aujourd'hui, à peu près tout en IA générative repose sur cette architecture ; en comprendre l'intérieur revient à comprendre la moitié du domaine.
