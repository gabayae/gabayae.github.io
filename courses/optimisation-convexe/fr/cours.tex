...
La convexité est l'une des rares propriétés mathématiques où la théorie devient \emph{plus simple} à mesure qu'on l'approfondit. Un problème d'optimisation convexe a un optimum global, qui est en pratique calculable, et qu'on peut souvent caractériser par les conditions de Karush--Kuhn--Tucker. Ce fait fonde une grande partie de la statistique moderne (régression régularisée, SVM, méthodes spectrales), du machine learning (apprentissage profond passé par la convexité de la couche finale), et de l'optimisation industrielle.
