% ============================================================
% MACHINE LEARNING — Course Notes (L3/Master 1)
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, text width=8cm, align=center]
    at ([yshift=0.5cm]current page.center) {Machine Learning};
  ...
  \node[anchor=north, text=blue!50!black]
    at ([yshift=-8cm]current page.center) {L3--M1 --- 2025--2026};
  ...
  \node[anchor=center, text width=10cm, align=center, text=blue!40!black, font=\itshape]
    at ([yshift=-11cm]current page.center) {``A computer program is said to learn from experience E with respect to some class of tasks T and performance measure P, if its performance at tasks in T, as measured by P, improves with experience E.'' --- Tom Mitchell};
...
\input{chapters/ch02_regression}
\input{chapters/ch03_classification}
\input{chapters/ch04_regularization}
\input{chapters/ch05_svm}
\input{chapters/ch06_trees}
\input{chapters/ch07_ensembles}
\input{chapters/ch08_unsupervised}
\input{chapters/ch09_dimensionality}
\input{chapters/ch10_bayesian}
\input{chapters/ch11_selection}
\input{chapters/ch12_kernels}
