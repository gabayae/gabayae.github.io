...
% --- hook ---
En 1959, Arthur Samuel publie aux laboratoires IBM un programme qui joue aux dames. Ce n'est pas la nouveaut\'e~: des moteurs de dames existaient d\'ej\`a. La nouveaut\'e est qu'apr\`es quelques milliers de parties contre lui-m\^eme, le programme bat r\'eguli\`erement Samuel. Aucune r\`egle de jeu n'a \'et\'e ajout\'ee entre la version de d\'epart et celle qui le bat~; le code, lui, n'a pas chang\'e. Ce qui a chang\'e, ce sont les poids stock\'es dans une table de coefficients. Samuel forge alors une expression pour d\'ecrire ce qu'il vient d'observer~: \emph{machine learning}. L'id\'ee tient en une phrase~: au lieu d'\'ecrire le programme qui r\'esout le probl\`eme, on \'ecrit un programme qui apprend \`a r\'esoudre le probl\`eme. Soixante-cinq ans plus tard, les algorithmes qui filtrent vos spams, ceux qui d\'ecident des cr\'edits accord\'es par votre banque et ceux qui d\'etectent les tumeurs sur les IRM descendent tous de cette m\^eme intuition. Ce chapitre pose le vocabulaire qui va structurer le reste du cours~: t\^ache, exp\'erience, perte, g\'en\'eralisation. Sans ces quatre mots, tout ce qui suit reste opaque~; avec eux, presque tout devient mod\'elisable.
