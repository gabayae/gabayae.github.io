...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Mathematical Modeling};
...
\input{chapters/ch01_process}
\input{chapters/ch02_dimensional}
\input{chapters/ch03_populations}
\input{chapters/ch04_epidemiology}
\input{chapters/ch05_chaos}
\input{chapters/ch06_diffusion}
\input{chapters/ch07_economic}
\input{chapters/ch08_optimization}
\input{chapters/ch09_stochastic}
\input{chapters/ch10_case_studies}
