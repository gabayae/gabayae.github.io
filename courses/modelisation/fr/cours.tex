...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Mod\'elisation Math\'ematique};
...
\input{chapitres/ch01_processus}
\input{chapitres/ch02_dimensionnelle}
\input{chapitres/ch03_populations}
\input{chapitres/ch04_epidemiologie}
\input{chapitres/ch05_chaos}
\input{chapitres/ch06_diffusion}
\input{chapitres/ch07_economique}
\input{chapitres/ch08_optimisation}
\input{chapitres/ch09_stochastiques}
\input{chapitres/ch10_etudes_cas}

\backmatter
\begin{thebibliography}{99}
\bibitem{murray} Murray, J.D., \emph{Mathematical Biology}, 3rd ed., 2 vols., Springer, 2002--2003.
\bibitem{strogatz} Strogatz, S.H., \emph{Nonlinear Dynamics and Chaos}, 2nd ed., Westview, 2015.
\bibitem{fowler} Fowler, A.C., \emph{Mathematical Models in the Applied Sciences}, Cambridge, 1997.
\end{thebibliography}
\printindex
\end{document}