...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Statistique Bay\'esienne};
...
\input{chapitres/ch01_paradigme}
\input{chapitres/ch02_conjugaison}
\input{chapitres/ch03_estimation}
\input{chapitres/ch04_tests}
\input{chapitres/ch05_prediction}
\input{chapitres/ch06_hierarchiques}
\input{chapitres/ch07_metropolis}
\input{chapitres/ch08_gibbs}
\input{chapitres/ch09_variationnelle}
\input{chapitres/ch10_non_parametrique}
\input{chapitres/ch11_applications}

\backmatter
\begin{thebibliography}{99}
\bibitem{gelman} Gelman, A. et al., \emph{Bayesian Data Analysis}, 3rd ed., CRC Press, 2013.
\bibitem{robert} Robert, C.P., \emph{The Bayesian Choice}, 2nd ed., Springer, 2007.
\bibitem{bernardo} Bernardo, J.M. and Smith, A.F.M., \emph{Bayesian Theory}, Wiley, 2000.
\bibitem{mcelreath} McElreath, R., \emph{Statistical Rethinking}, 2nd ed., CRC Press, 2020.
\end{thebibliography}
\printindex
\end{document}