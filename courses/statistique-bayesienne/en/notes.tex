...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Bayesian Statistics};
...
\input{chapters/ch01_paradigm}
\input{chapters/ch02_conjugacy}
\input{chapters/ch03_estimation}
\input{chapters/ch04_testing}
\input{chapters/ch05_prediction}
\input{chapters/ch06_hierarchical}
\input{chapters/ch07_metropolis}
\input{chapters/ch08_gibbs}
\input{chapters/ch09_variational}
\input{chapters/ch10_nonparametric}
