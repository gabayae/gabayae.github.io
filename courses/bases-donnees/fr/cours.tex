...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Bases de Donn\'ees};
...
En juin 1970, Edgar F. Codd, chercheur \`a IBM, publie un article de douze pages dans les \emph{Communications of the ACM}. Le titre, \emph{A Relational Model of Data for Large Shared Data Banks}, ne pr\'edit rien de ce qui va suivre. \`A l'\'epoque, les bases de donn\'ees sont hi\'erarchiques, propri\'etaires, accessibles via des langages de programmation sp\'ecifiques. Codd propose l'inverse~: une donn\'ee est un n-uplet dans une relation, et les requ\^etes se formulent dans un langage alg\'ebrique ind\'ependant de l'impl\'ementation physique. Cinquante-cinq ans plus tard, SQL --- direct descendant de ce papier --- reste le langage avec lequel la quasi-totalit\'e des donn\'ees structur\'ees du monde est interrog\'ee.
...
\input{chapitres/ch02_entite_relation}
\input{chapitres/ch03_algebre}
\input{chapitres/ch04_sql_base}
\input{chapitres/ch05_jointures}
\input{chapitres/ch06_agregation}
\input{chapitres/ch07_normalisation}
\input{chapitres/ch08_transactions}
\input{chapitres/ch09_indexation}
\input{chapitres/ch10_etl}
\input{chapitres/ch11_nosql}

\backmatter
\begin{thebibliography}{99}
\bibitem{ramakrishnan} Ramakrishnan, R. and Gehrke, J., \emph{Database Management Systems}, 3rd ed., McGraw-Hill, 2003.
\bibitem{date} Date, C.J., \emph{An Introduction to Database Systems}, 8th ed., Pearson, 2004.
\bibitem{silberschatz} Silberschatz, A., Korth, H.F. and Sudarshan, S., \emph{Database System Concepts}, 7th ed., McGraw-Hill, 2020.
\end{thebibliography}
\printindex
\end{document}