...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries, rotate=-15]
    at ([yshift=0.3cm]current page.center) {Databases};
...
\input{chapters/ch02_er_model}
\input{chapters/ch03_algebra}
\input{chapters/ch04_sql_basics}
\input{chapters/ch05_joins}
\input{chapters/ch06_aggregation}
\input{chapters/ch07_normalization}
\input{chapters/ch08_transactions}
\input{chapters/ch09_indexing}
\input{chapters/ch10_etl}
\input{chapters/ch11_nosql}
