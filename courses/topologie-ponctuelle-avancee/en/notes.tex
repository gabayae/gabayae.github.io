...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, text=white, font=\Huge\bfseries]
    at ([yshift=-6cm]current page.north) {Advanced Point-Set Topology};
  ...
  \node[anchor=center, text width=12cm, align=center, text=blue!60!black, font=\itshape]
    at ([yshift=-16cm]current page.north) {``A mathematician is a machine for turning coffee into theorems.''\\[4pt]--- Alfr\'ed R\'enyi};
...
\input{chapters/ch02_t0_specialization}
\input{chapters/ch03_sober_locales}
\input{chapters/ch04_quasi_metrics}
\input{chapters/ch05_bitopological}
\input{chapters/ch06_scott}
\input{chapters/ch07_convergence}
\input{chapters/ch08_compactness}
\input{chapters/ch09_theoretical_cs}
\input{chapters/ch10_fixed_points}
